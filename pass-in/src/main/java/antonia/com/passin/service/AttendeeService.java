...
import antonia.com.passin.dto.attendee.AttendeeDetails;
import antonia.com.passin.dto.attendee.AttendeesListResponseDTO;
import antonia.com.passin.dto.attendee.AttendeeBadgeDTO;
import antonia.com.passin.repositories.AttendeeRepository;
...
public class AttendeeService {
    ...
    private Attendee getAttendee(String attendeeId){
        return this. attendeeRepository.findById(attendeeId).orElseThrow(() -> new AttendeeNotFoundException("Attend not found with ID:" + attendeeId));
